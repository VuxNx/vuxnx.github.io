...
![{E568B841-2437-4650-B40C-55E4111F673C}](https://hackmd.io/_uploads/BJw4HyPmle.png)
...
<div style="background-color: #dbeafe; border-left: 4px solid #3b82f6; padding: 10px; margin: 20px 0; border-radius: 6px; font-weight: bold; color: #1e3a8a;">
...
![Screenshot](assets/img/writeups/malicious_repo/postman_call.png)
...
![Screenshot](assets/img/writeups/malicious_repo/error_log.png)

<h1>Deobfuscate the response file</h1>
...
I’ll upload the full code to GitHub at the following link: [https://github.com/VuxNx/REPO_SCAM_WU](https://github.com/VuxNx/REPO_SCAM_WU)
