---
title: "Writeup: HCMUS-CTF 2025 Finals Write-up"
date: 2025-07-15
categories: [writeups]
tags: [web, misc, ctf]
comments: true
...
This is a write-up for the Web/Misc challenge in the final round of the HCMUS-CTF 2025 competition that I recently participated in. Here is the link to the [challenge](placeholder). During the competition, three teams solved this challenge (including mine 🤺). Without further ado, let’s dive into the problem.
...
> Note: The cookie here includes PHPSESSID and ticket.
{: .prompt-info }
